...
use super::super::super::config::NodeConfig;
use super::super::super::dial::auto_dial_peer_from_book;
use super::super::super::events::{self, SwarmEventContext};
use super::super::super::public_ip;
use super::super::super::runtime_tasks::apply_public_ip_probe_result;
use super::super::NodeRuntimeContext;
use super::super::RuntimeState;
use super::super::{observability, periodic};
...
pub(in crate::node::runtime) async fn run_node_runtime(ctx: NodeRuntimeContext) {
    ...
    let mut dht_refresh_sleep = Box::pin(tokio::time::sleep_until(
        runtime_state.dht_refresh_schedule.next_due().into(),
    ));
    ...
    loop {
        tokio::select! {
            ...
            _ = &mut dht_refresh_sleep => {
                ...
                dht_refresh_sleep
                    .as_mut()
                    .reset(runtime_state.dht_refresh_schedule.next_due().into());
            }
