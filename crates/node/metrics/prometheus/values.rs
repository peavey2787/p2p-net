...
pub(super) fn snapshot_metric_values(s: &NodeSnapshot) -> Vec<(&'static str, String)> {
    vec![
        ...
        metric("p2p_peer_book_discovered_peers", s.peer_book_discovered_peers),
        metric("p2p_auto_connect_enabled", flag(s.auto_connect_enabled)),
        metric("p2p_auto_connect_dial_attempts", s.auto_connect_dial_attempts),
        metric("p2p_auto_connect_dial_failures", s.auto_connect_dial_failures),
        metric("p2p_auto_connect_awaiting_address_peers", s.auto_connect_awaiting_address_peers),
        metric("p2p_connection_plan_pending_peers", s.connection_plan_pending_peers),
        ...
        metric("p2p_dht_provider_announce_attempts", s.dht_provider_announce_attempts),
        metric("p2p_dht_provider_announce_failures", s.dht_provider_announce_failures),
        metric("p2p_dht_provider_queries", s.dht_provider_queries),
        metric("p2p_dht_provider_query_failures", s.dht_provider_query_failures),
        metric("p2p_dht_provider_records_found", s.dht_provider_records_found),
        metric("p2p_dht_provider_queries_finished", s.dht_provider_queries_finished),
        metric("p2p_dht_provider_peers_discovered", s.dht_provider_peers_discovered),
        ...
        metric("p2p_public_bootstrap_seed_count", s.public_bootstrap_seed_count),
        metric("p2p_public_rendezvous_candidate_count", s.public_rendezvous_candidate_count),
        metric("p2p_public_relay_candidate_count", s.public_relay_candidate_count),
        ...
        metric("p2p_platform_can_listen_tcp", flag(s.platform_can_listen_tcp)),
        metric("p2p_platform_can_listen_quic", flag(s.platform_can_listen_quic)),
        metric("p2p_relay_server_enabled", flag(s.relay_server_enabled)),
        metric("p2p_mediator_enabled", flag(s.mediator_enabled)),
        metric("p2p_mediator_active_reservations", s.mediator_active_reservations),
        metric("p2p_mediator_active_circuits", s.mediator_active_circuits),
        metric("p2p_mediator_dcutr_attempts_observed", s.mediator_dcutr_attempts_observed),
        metric("p2p_mediator_denied_reservations", s.mediator_denied_reservations),
        metric("p2p_mediator_denied_circuits", s.mediator_denied_circuits),
        metric("p2p_mediator_abuse_rate_limit_events", s.mediator_abuse_rate_limit_events),
        metric("p2p_relay_reservations_accepted", s.relay_reservations_accepted),
        ...
        metric("p2p_relay_discovery_enabled", flag(s.relay_discovery_enabled)),
        metric("p2p_relay_discovery_selected_relays", s.relay_discovery_selected_relays.len()),
        metric("p2p_relay_discovery_candidate_count", s.relay_discovery_candidate_count),
        metric("p2p_relay_discovery_public_candidates", s.relay_discovery_public_candidates),
        metric("p2p_relay_discovery_failures", s.relay_discovery_failures),
        metric("p2p_relay_discovery_replacements", s.relay_discovery_replacements),
        ...
        metric("p2p_dcutr_upgrade_eligible_connections", s.dcutr_upgrade_eligible_connections),
